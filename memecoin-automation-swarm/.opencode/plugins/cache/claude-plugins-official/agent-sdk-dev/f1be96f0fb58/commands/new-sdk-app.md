...
1. **Start with the overview**: https://docs.opencode.com/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://docs.opencode.com/en/api/agent-sdk/typescript
   - Python: https://docs.opencode.com/en/api/agent-sdk/python
...
6. **Optional: Create .opencode directory structure**:
   - Offer to create `.opencode/` directory for agents, commands, and settings
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://docs.opencode.com/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://docs.opencode.com/en/api/agent-sdk/python
