...
- [Agent SDK Overview](https://docs.opencode.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.opencode.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.opencode.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.opencode.com/en/api/agent-sdk/examples)
