...
cp -r /root/cli-anything/cli-anything-plugin ~/.opencode/plugins/cli-anything
...
ls ~/.opencode/plugins/cli-anything
...
3. **Read HARNESS.md:** Understand the methodology at `~/.opencode/plugins/cli-anything/HARNESS.md`
