...
```
~/.opencode/skills/                    # Personal skills location
└── my-skill/                        # Skill directory (MUST be at top level!)
    └── SKILL.md                     # REQUIRED: Main skill file
```

**IMPORTANT**: Skills MUST be directly under `~/.opencode/skills/[skill-name]/`.
...
└── [your-skills]/
```
- **Path**: `~/.opencode/skills/` or `$HOME/.opencode/skills/`
...
└── [team-skills]/
```
- **Path**: `.opencode/skills/` in project root
...
- [ ] Directory is DIRECTLY in `~/.opencode/skills/[skill-name]/` or `.opencode/skills/[skill-name]/`
...
### Official Resources
- [Anthropic Agent Skills Documentation](https://docs.opencode.com/en/docs/agents-and-tools/agent-skills)
- [GitHub Skills Repository](https://github.com/anthropics/skills)
- [Claude Code Documentation](https://docs.opencode.com/en/docs/claude-code)
