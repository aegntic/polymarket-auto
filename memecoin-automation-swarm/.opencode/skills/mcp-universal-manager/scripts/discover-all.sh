...
discover_claude_code() {
    ...
    local claude_config=$(get_config_value "platforms.opencode-code.config_path" "~/.config/claude/claude_desktop_config.json")
    local claude_enabled=$(get_config_value "platforms.opencode-code.enabled" "true")
