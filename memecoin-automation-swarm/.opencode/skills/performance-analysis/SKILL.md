...
- [Bottleneck Detection Guide](/workspaces/claude-code-flow/.opencode/commands/analysis/bottleneck-detect.md)
- [Performance Report Guide](/workspaces/claude-code-flow/.opencode/commands/analysis/performance-report.md)
- [Performance Bottlenecks Overview](/workspaces/claude-code-flow/.opencode/commands/analysis/performance-bottlenecks.md)
