...
```
~/.opencode/skills/avant-garde-frontend-architect/library/
...
~/.opencode/skills/avant-garde-frontend-architect/scripts/add-component.sh \
...
~/.opencode/skills/avant-garde-frontend-architect/scripts/list-components.sh \
  --category "components/cards"

# Search for components by keyword
~/.opencode/skills/avant-garde-frontend-architect/scripts/search-library.sh \
  --keyword "glass"

# Get component details
~/.opencode/skills/avant-garde-frontend-architect/scripts/get-component.sh \
  --name "floating-asymmetric-nav"
```
